...
<div class="row">
    ...
    <div class="col-xl-4 col-md-6 col-12">
            ...
            <div class="collapse show" id="grupo_data">
                <div class="card-body">
                    ...
                    <form action="grupos/post_editar" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="horario">Horario de Actividades</label>
        ...
        <div class="card shadow mb-4">
            <!-- Card Header - Accordion -->
            <a href="#grupo_horario" class="d-block card-header py-3" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="grupo_horario">
                <h6 class="m-0 font-weight-bold text-primary">Horario de Actividades</h6>
            </a>
            <!-- Card Content - Collapse -->
