...
<div class="row">
    <div class="col-xl-6 col-md-6 col-12">
        ...
        <div class="card shadow mb-4">
            ...
            <a href="#alumno_data" class="d-block card-header py-3" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="alumno_data">
            ...
            <div class="collapse show" id="alumno_data">
                <div class="card-body">
                    <form action="alumnos/post_editar" method="post">
                        ...
                        <?php endif; ?>
                        <button class="btn btn-success" type="submit" <?php echo empty($d->grupos)? 'disabled':null;?> >Actualizar alumno</button> 
                    </form>
                </div>
            </div>
        </div>
