...
<div class="row">
    <div class="col-xl-6">
        ...
        <div class="card shadow mb-4">
            ...
            <a href="#agregar_leccion" class="d-block card-header py-3" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="agregar_leccion">
                ...
                <div class="card-body">
                    <form action="lecciones/post_editar" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="video" name="video" placeholder="Ejemplo: https://youtu.be/FD2UEXhu-s" value="<?php echo $d->l->video;?>">
                        </div>
